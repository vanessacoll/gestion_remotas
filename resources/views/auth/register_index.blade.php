  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
     <section class="content-header">
      ...
      <h1 > <small>Registro y actualización de Usuarios</small></h1>
    </section>
...
<div class="col-md-4 ">
  ...
  <a href="{{route("register")}}" class="btn btn-primary">Agregar</a>
  @else
...
<div class="col-md-4">
  <a href="{{route("register.search")}}" class="btn btn-primary">Buscar</a>
</div>
