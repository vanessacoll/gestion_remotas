  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
     <section class="content-header">
      ...
      <h1 > <small>Registro y actualización de Remotas</small></h1>
    </section>
...
<div class="col-md-4 ">
  ...
  <a href="{{route("remotas.create")}}" class="btn btn-primary">Agregar</a>
  @else
...
<div class="col-md-4">
  <a href="{{route("remotas.search")}}" class="btn btn-primary">Buscar</a>
</div>
