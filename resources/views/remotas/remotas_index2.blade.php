...
<select class="form-select js-basic-single" name="cedula" id="organizerSingle" size="1" name="organizerSingle" data-options='{"removeItemButton":true,"placeholder":true}' required="">
