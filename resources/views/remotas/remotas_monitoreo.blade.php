...
<div class="col-12">
  <div class="card" id="table" data-list='{"page":10,"pagination":true,"fallback":"pages-table-fallback"}'>
      ...
      <div class="table-responsive scrollbar">
        <table class="table fs--1 mb-0 overflow-hidden">
          <thead class="bg-200 text-900">
            <tr>
              <th class="pe-1 align-middle white-space-nowrap">Remota</th>
            </tr>
          </thead>
          <tbody class="list">
                        ...
                        <td class="align-middle white-space-nowrap">
                            ...
                            <div class="d-flex align-items-center position-relative">
                              <div class="avatar avatar-2xl status-online">
                                <img class="rounded-circle" src="/assets/template_dark/img/avatar.png" alt="" />
                              </div>
                              <div class="flex-1 ms-3">
                                <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="{{$remota->url}}" target="_blank">{{$remota->nombre}}</a></h6>
