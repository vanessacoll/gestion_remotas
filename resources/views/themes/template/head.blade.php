<head>
 ...
 <!-- Bootstrap 4.5.2 - Comentado por si son necesarios despues.
...
-->
 ...
 <link rel="stylesheet" href="{{asset("assets/$theme/bower_components/Responsive-2.2.7/css/responsive.bootstrap.min.css")}}">
