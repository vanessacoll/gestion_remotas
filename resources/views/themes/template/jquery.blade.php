<!-- Comentado por si son necesarios despues, van con los Jquery.
 <script type="text/javascript" src="/media/js/site.js?_=30648b1410332bada11fa3ff8050ff88"></script>

<script type="text/javascript" src="/media/js/dynamic.php?comments-page=extensions%2Fresponsive%2Fexamples%2Fstyling%2Fbootstrap4.html" async></script>
-->

<script src="{{asset("assets/$theme/bower_components/jquery/dist/jquery.min.js")}}"></script>

<script src="{{asset("assets/$theme/bower_components/jquery/dist/jquery-3.5.1.js")}}"></script>
...
<script src="{{asset("assets/$theme/bower_components/datatables.net-bs/js/dataTables.bootstrap4.min.js")}}"></script>

<script src="{{asset("assets/$theme/bower_components/Responsive-2.2.7/js/dataTables.responsive.min.js")}}"></script>

<script src="{{asset("assets/$theme/bower_components/Responsive-2.2.7/js/responsive.bootstrap4.min.js")}}"></script>
