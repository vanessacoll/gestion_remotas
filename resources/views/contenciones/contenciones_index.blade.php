...
<div class="d-flex mb-4 mt-4"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-signal"></i></span>
  <div class="col">
    ...
    <p class="mb-0">Listado de Contenciones</p>
  </div>
</div>
      ...
      <div class="row flex-between-center">
        <div class="col-auto col-sm-6 col-lg-7">
          @can('registrar_contenciones')
            <a class="btn btn-falcon-default btn-md"  href="{{route("contenciones.create")}}">
        ...
        <table class="table fs--1 mb-0 overflow-hidden">
          ...
          <tbody class="list">
            ...
            <tr class="btn-reveal-trigger">
                        <td class="align-middle white-space-nowrap path">{{$contencion->id_contencion}}</td>
                        <td class="align-middle white-space-nowrap name">{{$contencion->des_contencion}}</td>
                        <td class="align-middle text-end">
                          <div class="dropdown font-sans-serif position-static d-inline-block btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none float-end" type="button" id="dropdown0" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                            <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown0">
                              ...
                              <a class="dropdown-item" href="{{route("contenciones.edit",['contencion' => $contencion->id_contencion])}}">Editar</a>      
                              @else
